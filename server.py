...
async def on_update_report(data, ven_id, resource_id, measurement):
    ...
    # Code for maximum value removed
    # Feel free to repurpose for your own usage
...
# Address is localhost:8080 by default
# To define address, use http_host option
# Ex. http_host='192.168.10.15'
# You can also use http_port to modify which port is used
